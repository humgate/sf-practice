...
public class CombinedSorters {
     ...
     * сортировки анализировать n и вызывать (или не вызывать) другой метод сортировки. Согласно SOLID неправильно
     * изменять реализации уже реализованных ранее методов сортировки. Поэтому написаны новые реализации для
